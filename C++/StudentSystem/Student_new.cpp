...
void Student_new::readConfig(char *config, iptData &configData)
{
    ...
    ofstream out("/Users/worlder/Documents/Language/C++/StudentSystem/out_config_new.txt");
    if (out.is_open())
    {
    ...
    in.open("/Users/worlder/Documents/Language/C++/StudentSystem/out_config_new.txt");
...
void Student_new::readConfig(iptData &configData)
{
    ...
    ifstream in;
    vector<string> configVecStr;
    in.open("/Users/worlder/Documents/Language/C++/StudentSystem/config.txt");
    if (!in.is_open())
    {
        cout << "Error opening file config.txt" << endl;
        exit(1);
...
void Student_new::saveData(vector<Student_new> &vecStudNew, Dorm_info &dorm)
{
    ...
    out.open("\\\\Mac\\Home\\Desktop\test\\StudentSystem\\" + configData_new.SAVE_FILE_NAME);
    if (!out.is_open())
    {
                           ...
                           iptData &configLoad)
{
    ...
    in.open("/Users/worlder/Documents/Language/C++/StudentSystem/" + configData_new.SAVE_FILE_NAME);
    if (!in.is_open())
    {
    ...
    in >> configLoad.FLOOR >> configLoad.ROOM >> configLoad.CAPACITY;
