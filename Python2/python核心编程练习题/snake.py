...
def gameover():
    if lx[-1] > 780 or lx[-1] < 0 or ly[-1] > 580 or ly[-1] < 0:
        try:
            ...
            f.create_text(400, 330, text='Ur Score : ' + str(len(l) - 3),
                          font=('Fixdsys', 40), fill='blue', justify=CENTER)
...
# 这里需要一张底色不为白色、gif格式的图片，可以自行调整（我划的线是白色）
# pic = PhotoImage(file='C:\Users\wj\Desktop\\snake.gif')
